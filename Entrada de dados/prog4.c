...
/* Exercícios:
   1) Modifique o programa para que seja respeitado o aumento da janela para o valor máximo dado por LARGURA_MAXIMA_JANELA 
   2) Modifique o programa para permitir que o usuário também possa aumentar a altura da janela
   3) Modifique o programa para que seja respeitado o aumento da janela para o valor máximo dado por ALTURA_MAXIMA_JANELA 
   4) Modifique o programa para que a cada pressionamento de uma tecla de direção (ESQUERDA OU PARA_BAIXO) a cor da janela mude
*/